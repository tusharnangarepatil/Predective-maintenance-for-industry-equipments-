...
st.image('bg.jpeg', use_column_width=True)  # Replace 'banner_image.png' with the path to your banner image
...
def user_input_features():
    ...
    feature_values = {
        ...
        #'Usage Hourse': st.sidebar.slider('Usage Hr', min_value=0, max_value=720, value=360)
